...
# Darbot companion: the dependency lock is qualified only on standard CPython.
if (
    ...
    raise RuntimeError(
        "Darbot Unsloth Zoo requires standard (GIL-enabled) CPython >=3.14.7,<3.15."
    )
