...
Check "node22.13 + npm11.10 -> system" ((D "v22.13.0" "11.10.0" "0") -eq "system")
Check "node24 + npm11 -> system"      ((D "v24.17.0" "11.13.0" "0") -eq "system")
Check "node26 + npm12 -> system"      ((D "v26.7.0" "12.0.0" "0") -eq "system")
# bundled (the reported bug: fine Node, stale npm)
Check "node22 + npm10 -> bundled"     ((D "v22.17.1" "10.9.2"  "0") -eq "bundled")
Check "node22 + npm11.9 -> bundled"   ((D "v22.17.1" "11.9.9" "0") -eq "bundled")
Check "node20.19 -> bundled"          ((D "v20.19.0" "11.13.0" "0") -eq "bundled")
Check "node23 -> bundled"             ((D "v23.5.0" "11.13.0" "0") -eq "bundled")
Check "node22.12 -> bundled"          ((D "v22.12.0" "11.13.0" "0") -eq "bundled")
...
Check "node prerelease -> bundled"    ((D "v24.0.0-rc.1" "11.13.0" "0") -eq "bundled")
Check "npm prerelease -> bundled"     ((D "v24.0.0" "11.10.0-beta.1" "0") -eq "bundled")
# skip flag
